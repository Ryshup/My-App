    ...
    sections: [
      {
        ...
        icon: CodeIcon,
        items: [
          { label: "Product Design", route: "/services/productDesign" },
          { label: "Application Development", route: "/services/appDev" },
          { label: "Software Development", route: "/services/softwareDev" },
          { label: "QA and Testing", route: "/services/qaTesting" },
          { label: "DevOps", route: "/services/devops" },
          "Product Management",
        ],
      },
      {
        ...
        items: [
          {
            ...
            route: "/services/legacyModernization",
          },
          { label: "Blockchain", route: "/services/blockchainDev" },
          { label: "Cloud", route: "/services/cloudSolutions" },
          { label: "Cybersecurity", route: "/services/cybersecurity" },
          { label: "IoT", route: "/services/iotSolutions" },
          { label: "AR/VR", route: "/services/arvrSolutions" },
        ],
      },
      {
  ...
  industries: {
    sections: [
      ...
      },
      {
        ...
        icon: CodeIcon,
        items: [
          { label: "AI Solutions", route: "/industries/aiSolutions" },
          { label: "Blockchain Industry", route: "/industries/blockchain" },
        ],
      },
    ],
  },
